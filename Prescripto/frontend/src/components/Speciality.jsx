...
import { specialityData } from "../assets/assets_frontend";
...
const Speciality = () => {
  return (
    <div id='speciality' className='flex flex-col items-center gap-4 py-10 text-gray-800'>
      ...
      <p className='sm:w-1/3 text-center text-sm'>Simply browse through our extensive list of trusted doctors, schedule your appoitment hassle-free</p>
